...
import os
# Support custom CA bundle from Node extra certs (e.g. corporate proxies) for curl_cffi
if "CURL_CA_BUNDLE" not in os.environ and "NODE_EXTRA_CA_CERTS" in os.environ:
    os.environ["CURL_CA_BUNDLE"] = os.environ["NODE_EXTRA_CA_CERTS"]
